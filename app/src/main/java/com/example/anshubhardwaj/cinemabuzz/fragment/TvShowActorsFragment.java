...
import com.example.anshubhardwaj.cinemabuzz.adapter.CastAdapter;
import com.example.anshubhardwaj.cinemabuzz.api.ApiClient;
import com.example.anshubhardwaj.cinemabuzz.api.ApiInterface;
import com.example.anshubhardwaj.cinemabuzz.object.CastObject;
...
public class TvShowActorsFragment extends Fragment implements SharedItemClickListner {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_tv_show_actors,container,false);
